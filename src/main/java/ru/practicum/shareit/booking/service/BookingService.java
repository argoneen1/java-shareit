...
public interface BookingService {
    ...
    List<Booking> findByBooker(Long sharerId, BookingRequestsState state, int from, int size);

    List<Booking> findByOwner(Long sharerId, BookingRequestsState state, int from, int size);
}
